...
import { Loader2, LogOut, Sparkles, Search, Download, LayoutTemplate, List, Tag as TagIcon, Clock, BarChart3, Archive, Moon, Sun, BookOpen, Image as ImageIcon } from 'lucide-react';
