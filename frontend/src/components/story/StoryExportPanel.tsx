...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    h2 { font-size: 1.3em; margin: 40px 0 12px; color: #FF8FA3; border-bottom: 1px solid #FFB4A2; padding-bottom: 8px; }
    ...
    .node-type { display: inline-block; font-size: 0.7em; padding: 2px 8px; border-radius: 12px; background: #FF8FA3; color: white; margin-bottom: 8px; }
    .mood { font-size: 0.75em; color: #FF8FA3; font-style: italic; }
    .location { font-size: 0.8em; color: #5A3E4C; margin-bottom: 8px; }
    hr { border: none; border-top: 1px solid #FFB4A2; margin: 32px 0; opacity: 0.3; }
    ...
    <div className="absolute top-0 right-0 h-full w-[320px] bg-white/95 dark:bg-[#2a2438]/95 backdrop-blur-xl border-l border-[#FFB4A2]/15 dark:border-[#FF8FA3]/10 shadow-2xl z-50 flex flex-col overflow-hidden">
      ...
      <div className="flex-1 p-5 space-y-3">
        ...
        <button onClick={handleExportMarkdown} disabled={exporting !== null}
          className="w-full flex items-center gap-3 p-4 rounded-xl border border-[#FFB4A2]/15 dark:border-[#FF8FA3]/10 hover:bg-[#FFB4A2]/5 dark:hover:bg-[#FF8FA3]/5 transition-all">
