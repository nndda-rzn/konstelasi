...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#0f0f14] relative overflow-hidden">
      ...
      <div className="absolute top-1/4 -left-32 w-96 h-96 rounded-full bg-red-600/10 blur-[100px] animate-orb-1" />
      <div className="absolute bottom-1/4 -right-32 w-80 h-80 rounded-full bg-rose-600/8 blur-[100px] animate-orb-2" />
