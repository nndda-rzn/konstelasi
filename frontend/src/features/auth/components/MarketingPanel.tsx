...
export function MarketingPanel() {
  return (
    <section className="hidden lg:block">
      <div className="relative overflow-hidden rounded-[32px] border border-white/10 bg-[rgba(14,12,22,0.6)] p-10 shadow-[0_24px_70px_rgba(0,0,0,0.4)] backdrop-blur-xl">
        ...
        <div className="relative">
          ...
          <h1 className="mt-7 max-w-xl text-[44px] font-extrabold leading-[1.08] tracking-[-0.03em] text-[#F8F4EF]">
            Ruang pribadi untuk merangkai cerita dengan tenang.
          </h1>

          <p className="mt-4 max-w-lg text-base leading-[1.7] text-[#A99EA6]">
