...
/**
 * AuthPromptModal - Soft glass-morphism prompt shown when an unauthenticated
 * user attempts a state-changing action (e.g. save to canvas).
 * Replaces the previous hard-redirect to /login.
 */
